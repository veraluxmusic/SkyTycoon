...
{
    /// <summary>
    /// Burst-compatible OpenSimplex2S 2D evaluator.
    /// </summary>
    internal readonly struct OpenSimplex2S2DEvaluator
    {
        ...
        public OpenSimplex2S2DEvaluator(NativeArray<float2> gradients2D)
        {
            this.gradients2D = gradients2D;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float Evaluate(long seed, float2 point, OpenSimplex2SFbmOrientation orientation)
        {
            return orientation == OpenSimplex2SFbmOrientation.ImproveX
